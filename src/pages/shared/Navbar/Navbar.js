        ...
        <>
            {['md'].map((expand) => (
                <Navbar key={expand} bg="" expand={expand} className="mb-3 ">
                    <Container fluid>
                        <Navbar.Brand className='pointer' onClick={() => navigate('/')} ><h1 className='weapon'><span className='text-success fs-3 fw-bold'>Weapon World</span></h1></Navbar.Brand>
                        ...
                        >
                            ...
                            <Offcanvas.Body>
                                <Nav className="justify-content-end flex-grow-1 pe-3">
                                    ...
                                    <Nav.Link className=' fw-bold' as={Link} to="/blogs">Blog</Nav.Link>
